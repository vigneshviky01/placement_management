...
const StudentOrPoc = () => {
  ...
  return (
    <div className='w-full h-screen bg-gray_bg flex justify-center items-center'>
        ...
        <div className='bg-primary cursor-pointer text-white font-semibold max-sm:px-7 px-9 rounded-md text-center sm:text-xl  max-sm:py-4 py-6 ' onClick={()=>{navigate('/poc')}}>
                Login as POC
            </div>
